...
public class AddTaskTest extends AndroidTest {
    ...
    public void addNewTask() {
        ...
        // Fill the task description text field
        {
            ...
            driver.findElement(By.xpath("//android.view.View[@resource-id=\"btn_editor_undo\"]")).click();  // Click on undo button
            driver.findElement(By.xpath("//android.view.View[@resource-id=\"btn_editor_redo\"]")).click();  // Click on redo button
        ...
        driver.findElement(By.xpath("//android.view.View[@resource-id=\"dd_editor_priority_item_0\"]")).click();
        ...
        // Make sure the task priority is setted
        {
            ...
            Assertions.assertEquals(defaultPriority, priorityText.getAttribute("text"), "Task priority does not match");
        }
        ...
        driver.findElement(By.xpath("//android.view.View[@resource-id=\"btn_datetime_dismiss\"]")).click();
